...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create HomeCookd-55ad
  fly apps create HomeCookd-55ad-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app HomeCookd-55ad
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app HomeCookd-55ad-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'HomeCookd-55ad-staging' does not match app name in config file 'HomeCookd-55ad'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name HomeCookd-55ad-db
  fly postgres attach --app HomeCookd-55ad HomeCookd-55ad-db

  fly postgres create --name HomeCookd-55ad-staging-db
  fly postgres attach --app HomeCookd-55ad-staging HomeCookd-55ad-staging-db
  ```
